...
* **Before body** : plain text or html code to add before report table. Supports also job & env variables , for example ${WORKSPACE}
...
=== 1.1.0 (9 Oct 2020)
 * Support job and env variables
 
=== 1.0.10 (13 Aug 2020)
 * FIX : Support multi levels of folders
