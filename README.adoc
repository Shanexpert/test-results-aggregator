...
Supports 'free style project' and 'pipeline' after https://github.com/jenkinsci/test-results-aggregator-plugin/releases/tag/test-results-aggregator-1.2.7[1.2.7], samples see below.
