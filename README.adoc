...
Supports 'https://plugins.jenkins.io/test-results-aggregator/#free-style-job-configuration[free style project]' and 'https://plugins.jenkins.io/test-results-aggregator/#plugin-content-pipeline-syntax[pipeline]' (after https://github.com/jenkinsci/test-results-aggregator-plugin/releases/1.2.7[1.2.7]).
