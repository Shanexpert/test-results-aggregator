...
Supports 'free style project' and 'pipeline' after https://github.com/jenkinsci/test-results-aggregator-plugin/releases/1.2.7[1.2.7], samples see https://plugins.jenkins.io/test-results-aggregator/#plugin-content-pipeline-syntax[below].
