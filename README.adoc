...
Compared with the previous regarding job statuses and tests results. No diffs in report.

**7. Ignore Jobs from report by status **

image::IgnoreJobs.png[IgnoreJobs,900,align="right"]

Igonre from report jobs with status NOT_FOUND, DISABLED or ABORTED.
